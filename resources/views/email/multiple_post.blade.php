                                ...
                                <td>
                                    <div class="text text-center p-1">
                                        ...
                                        @if(@$single_post->post_type == 'article')
                                            <p><a href="{{$base_url}}/article/{{$single_post->slug}}" class="btn btn-primary">{{__('read_more')}}</a></p>
                                        @else
                                            <div class="icon">
                                                <a href="{{$base_url}}/article/{{@$single_post->slug}}">
                                                ...
                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td class="text-services text-left">
                                                            ...
                                                            <p><a href="{{$base_url}}/article/{{$post->slug}}" class="btn btn-primary">{{__('read_more')}}</a></p>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
