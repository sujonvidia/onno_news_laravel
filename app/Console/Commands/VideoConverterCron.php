            ...
            if($cron->video_id != null):
                    ...
                    try {
                        ...
                        if($resolution >= 1080):
                            ...
                            $video  -> v_144p=$videoUrl_256x144;
                            $video  -> v_240p=$videoUrl_320x240;
                            $video  -> v_360p=$videoUrl_480x360;
                            $video  -> v_480p=$videoUrl_858x480;
                            $video  -> v_720p=$videoUrl_1280x720;
                            $video  -> v_1080p=$videoUrl_1920x1080;
