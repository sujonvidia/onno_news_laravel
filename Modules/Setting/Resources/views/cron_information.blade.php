                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="recaptcha_settings" role="tabpanel">
                                     ...
                                     {{--        <div class="m-b-20">
                                            ...
                                            <div class="mb-2">
                                                <span><strong>{{ __('video_convert') }} {{ __('cPanel_cron_command') }} :</strong> */5 * * * * /usr/local/bin/php /home/username/project_path/artisan videoConverter:cron >> /dev/null/ 2>&1</span>
                                            ...
                                            <div class="mb-2">
                                                <span><strong>{{ __('schedule_post') }} {{ __('cPanel_cron_command') }} :</strong> */5 * * * * /usr/local/bin/php /home/username/project_path/artisan schedulepost:cron >> /dev/null/ 2>&1</span>
