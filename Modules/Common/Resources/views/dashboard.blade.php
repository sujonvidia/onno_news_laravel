...
<div class="container-fluid  dashboard-content">
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <h5 class="card-header">{{ __('top_hits_post') }}</h5>
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                @foreach($data['post_detail'] as $key => $value)
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td>{{ data_get($value, 'post.post.title') }} </td>
                                    <td>{{ data_get($value, 'post.post.language') }} </td>
                                    <td>{{ data_get($value, 'post.post.post_type') }} </td>

                                    <td>{{ data_get($value, 'hits') }} </td>
                                </tr>
                                @endforeach
                                </tbody>
                            </table>
